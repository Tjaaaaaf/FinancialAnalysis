...
public class DocumentWrapper implements IDocumentWrapper {
    ...
    public static class DocumentBuilder implements IDocumentBuilder {
        ...
        public DocumentBuilder(Document document, String fileName, int year) {
            ...
            this.currentTimePeriods = extractCurrentTimePeriods(document);
        }

        private Business extractBusiness(Document document) {
            return new Business(
                    document.getElementsByTagName("pfs-gcd:EntityCurrentLegalName").item(0).getTextContent(),
                    ...
                    document.getElementsByTagName("pfs-gcd:Box").item(0) == null ? ""
                            : document.getElementsByTagName("pfs-gcd:Box").item(0).getTextContent(),
                    document.getElementsByTagName("pfs-gcd:PostalCodeCity").item(0).getChildNodes().item(0) == null ? ""
                            : document.getElementsByTagName("pfs-gcd:PostalCodeCity").item(0).getTextContent(),
                    document.getElementsByTagName("pfs-gcd:CountryCode").item(0).getChildNodes().item(0) == null ? ""
                            : document.getElementsByTagName("pfs-gcd:CountryCode").item(0).getTextContent());
        }

        private ArrayList<String> extractCurrentTimePeriods(Document document) {
            ArrayList<String> currentTimePeriods = new ArrayList<String>();

            int index = 0;
            boolean currentYearFound = false, currentDurationFound = false;
            while (index < document.getElementsByTagName("xbrli:context").getLength()) {
                Node e = document.getElementsByTagName("xbrli:context").item(index);
